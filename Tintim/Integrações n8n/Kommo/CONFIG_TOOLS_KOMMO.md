...
| etapa | String | sim | Etapa de destino do card no funil. Use exatamente um destes valores: "Qualificação" quando começar a classificar o perfil do lead; "Agência / Parceiros" quando identificar que o lead é MQL (gestor de tráfego ou dono de agência com 3 ou mais clientes), antes de conseguir marcar a reunião; "Reunião Marcada" quando a reunião do Programa de Parceiros for agendada com sucesso; "Oferta Enviada" quando encaminhar um lead não-MQL para o time de vendas; "Handoff Humano Necessário" quando o caso precisar de atendimento humano ou suporte; "Venda perdida" quando o lead recusar claramente. |
...
Codigo canonico (conferido contra o export real do n8n em 2026-07-22): `Atualizar Card/Prepara dados.js`.
...
Codigo canonico (conferido contra o export real do n8n em 2026-07-22): `Atualizar Card/Avalia busca.js`.
...
Codigo canonico (conferido contra o export real do n8n em 2026-07-22): `Atualizar Card/Monta body.js`.
